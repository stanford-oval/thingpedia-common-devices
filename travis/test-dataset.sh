...
make source=user all_names="eval" release=universe translation_model=Helsinki-NLP/opus-mt-en-de src_lang=en tgt_lang=de nmt_model=nmt val_batch_size=200 temperature=0.0 translate_data
