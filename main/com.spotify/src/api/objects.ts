...
export function isEntityObject(x : any) : x is EntityObject {
    return (
        ...
        ["type", "id", "name", "uri"].every(
            (prop) => Object.prototype.hasOwnProperty.call(x, prop) && typeof x[prop] === "string"
        )
    );
}
...
export function isAlbumObject(x : any) : x is AlbumObject {
    return (
        ...
        Object.prototype.hasOwnProperty.call(x, "tracks") &&
        Object.prototype.hasOwnProperty.call(x, "popularity")
    );
}
...
export function isEpisodeObject(x : any) : x is EpisodeObject {
    return isSimplifiedEpisodeObject(x) && Object.prototype.hasOwnProperty.call(x, "album");
}
